    ...
    \subsection{Statistical Summary \& Visualizations}
        ...
        \begin{figure}[H]
            ...
            \begin{minipage}{0.48\textwidth}
                \centering
                \includegraphics[height=5cm]{distamt_original.png}
                \caption{Original Skewed Distribution}
                \label{fig:distamt-orig}
            \end{minipage}\hfill
            \begin{minipage}{0.48\textwidth}
                \centering
                \includegraphics[height=5cm]{distamt_log.png}
                \caption{Log-Transformed Distribution}
                \label{fig:distamt-log}
            \end{minipage}
            \caption{Transaction Amount Distribution. The log-transformation reveals a underlying normal-like structure, correcting the extreme skew observed in the raw data}
    ...
    \subsection{Computation and Interpretability}
        ...
        \begin{table}[H]
            ...
            \begin{minipage}{\linewidth}
                \centering
                \textbf{\normalsize Training Metrics} \\[5pt]
            ...
            \begin{minipage}{\linewidth}
                \centering
                \textbf{\normalsize Validation Metrics} \\[5pt]
                \begin{tabular}{|l|c|c|c|}
                    \hline
                    \textbf{Metric } & \textbf{LinearSVC} & \textbf{Decision Tree} & \textbf{XGBoost} \\
                    \hline
